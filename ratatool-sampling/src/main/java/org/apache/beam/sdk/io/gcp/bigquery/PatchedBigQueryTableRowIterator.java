 ...
 * distributed under BigDiffy.scalathe License is distributed on an "AS IS" BASIS,
 ...
 *
 * This file has been copied over since it's now removed from Scio
 */
@Deprecated
public class PatchedBigQueryTableRowIterator implements AutoCloseable {
   ...
   */
  static PatchedBigQueryTableRowIterator fromQuery(
      JobConfigurationQuery queryConfig, String projectId, Bigquery client) {
    checkNotNull(queryConfig, "queryConfig");
    checkNotNull(projectId, "projectId");
    checkNotNull(client, "client");
    return new PatchedBigQueryTableRowIterator(/* ref */null, queryConfig, projectId, client);
  }
